...
// Fetch data for Domestic Tourists from the database
$query = "SELECT * FROM domestic_tourists";
...
<head>
    ...
    <title>Graphs for Domestic Tourists</title>
</head>
<body>
    <div id="chart-container">
        <h1>Graphs for Domestic Tourists (2010 and 2011)</h1>
